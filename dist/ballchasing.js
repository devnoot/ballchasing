(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('node-fetch'), require('fs'), require('util'), require('stream'), require('path'), require('http'), require('https'), require('url')) :
  typeof define === 'function' && define.amd ? define(['exports', 'node-fetch', 'fs', 'util', 'stream', 'path', 'http', 'https', 'url'], factory) :
  (global = global || self, factory(global.ballchasing = {}, global.nodeFetch, global.fs, global.util, global.stream, global.path, global.http, global.https, global.url));
}(this, (function (exports, fetch, fs, util, require$$0$1, path, http, https, require$$0$2) {
  ...
  var FormData$1 = /*#__PURE__*/Object.assign(/*#__PURE__*/Object.create(null), form_data, {
    'default': form_data
  });
